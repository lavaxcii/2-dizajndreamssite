function SecondPageMainContent(props) {
  return (
    <div>
      <h3>Here be second page and its main component!</h3>
      <p>Here be something utterly woderfull and befiting page two content.</p>
...
export default SecondPageMainContent