function ThirdPageMainContent(props) {
  return (
    <div>
      <h3>Here be first page and its main component!</h3>
      <p>Here be something so mighty that even the proudest of proude gonna yelp!</p>
...
export default ThirdPageMainContent